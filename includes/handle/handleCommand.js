...
url: (await global.nodemodule["axios"]('https://apivip.kizz-kinncuti.repl.co/images/loli')).data.data,
method: "GET",
responseType: "stream"
})).data   
    ...
    const res = await axios.get(`https://apivip.kizz-kinncuti.repl.co/images/loli`);
var tho = res.data.data;
      const time = process.uptime();
		 var anh = Math.floor(time / (60 * 60));
		var la = Math.floor((time % (60 * 60)) / 60);
