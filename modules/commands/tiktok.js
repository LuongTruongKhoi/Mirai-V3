...
module.exports.run = async ({ api, event, args }) => {
  ...
  if (!args[0]) return api.sendMessage({body:`🌸====『 𝗧𝗜𝗞𝗧𝗢𝗞 𝗛𝗘𝗟𝗣 』====🌸\n━━━━━━━━━━━━━━━━━━\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝘃𝗶𝗱𝗲𝗼 <𝘂𝗿𝗹>: 𝗧𝗮̉𝗶 𝘃𝗶𝗱𝗲𝗼 𝘁𝘂̛̀ 𝗻𝗲̂̀𝗻 𝘁𝗮̉𝗻𝗴 𝗺𝗮̣𝗻𝗴 𝘅𝗮̃ 𝗵𝗼̣̂𝗶 𝘁𝗶𝗸 𝘁𝗼𝗸\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝗮𝘂𝗱𝗶𝗼 <𝘂𝗿𝗹>: 𝗟𝗮̂́𝘆 𝗻𝗵𝗮̣𝗰 𝘁𝘂̛̀ 𝘃𝗶𝗱𝗲𝗼 𝘁𝗶𝗸 𝘁𝗼𝗸\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝘀𝗲𝗮𝗿𝗰𝗵 <𝘁𝘂̛̀ 𝗸𝗵𝗼𝗮́>: 𝗧𝗶̀𝗺 𝗸𝗶𝗲̂́𝗺 𝘃𝗶𝗱𝗲𝗼 𝘁𝗶𝗸 𝘁𝗼𝗸\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝗽𝗼𝘀𝘁 <𝘁𝗲̂𝗻 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴>: 𝗫𝗲𝗺 𝘃𝗶𝗱𝗲𝗼 𝘁𝗿𝗲̂𝗻 𝘁𝗿𝗮𝗻𝗴 𝗰𝗮́ 𝗻𝗵𝗮̂𝗻 𝗰𝘂̉𝗮 𝗵𝗼̣\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝘁𝗿𝗲𝗻𝗱𝗶𝗻𝗴: 𝘁𝗶𝗸 𝘁𝗼𝗸 𝘁𝗿𝗲𝗻𝗱𝗶𝗻𝗴\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝗳𝗶𝗻𝗱𝘂𝘀𝗲𝗿 <𝘁𝗲̂𝗻 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴>: 𝗧𝗶̀𝗺 𝗸𝗶𝗲̂́𝗺 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 𝘁𝘂̛𝗼̛𝗻𝗴 𝘂̛́𝗻𝗴 𝘁𝗵𝗼̂𝗻𝗴 𝗾𝘂𝗮 𝘁𝘂̛̀ 𝗸𝗵𝗼𝗮́\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝗶𝗺𝗮𝗴𝗲𝘀 <𝘂𝗿𝗹>: 𝗧𝗮̉𝗶 𝗵𝗶̀𝗻𝗵 𝗮̉𝗻𝗵 𝘁𝘂̛̀ 𝘁𝗶𝗸 𝘁𝗼𝗸\n${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝗺𝘂𝘀𝗶𝗰 <𝘂𝗿𝗹>: 𝗧𝗮̉𝗶 𝗺𝗼̣̂𝘁 𝗯𝗮̉𝗻 𝗻𝗵𝗮̣𝗰 𝘁𝘂̛̀ 𝘁𝗶𝗸 𝘁𝗼k\n👉 𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝗱𝘂̀𝗻𝗴 𝗻𝗵𝘂̛ 𝘁𝗿𝗲̂𝗻 𝗩𝗶𝗱𝘂:${global.config.PREFIX}𝘁𝗶𝗸𝘁𝗼𝗸 𝘂𝗿𝗹 𝗵𝘁𝘁𝗽𝘀://𝘃𝘁.𝘁𝗶𝗸𝘁𝗼𝗸.𝗰𝗼𝗺/𝗭𝗦𝟴𝟱𝗤𝗽𝗺𝟯𝗘/\n⚠️ 𝗟𝘂̛𝘂 𝘆́ 𝗽𝗵𝗮̉𝗶 𝘃𝗶𝗲̂́𝘁 đ𝘂́𝗻𝗴 𝗰𝗵𝗶́𝗻𝗵 𝘁𝗮̉`,attachment: (await axios.get((await axios.get(`https://apivipvl.dbrr06.repl.co/nsfw/gaisexy?apikey=NNLvip_1671364276`)).data.data, {
                    responseType: 'stream'
                })).data},
    ...
    case "info":
      ...
      try {
        axios.get(encodeURI(`https://caochungdat.me/docs/tiktok/infouser?user=${keyword}`)).then(async (res) => {
          ...
          const { id, uniqueID, avatarThumb, avatarMedium, avatarLarger, signature, verified, secUid, secret, ftc, relation, openFavorite, commentSetting, duetSetting, stitchSetting, privateAccount, isADVirtual, isUnderAge18, ins_id, twitter_id, youtube_channel_title, youtube_channel_id, followingCount, followerCount, heartCount, videoCount, diggCount, heart,} = res.data;
